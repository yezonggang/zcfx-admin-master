				...
				<el-tab-pane name="xm">
					<el-card>
						<div slot="header" class="clearfix">
							<div class="info-bar">
								共检索到<span style="color: #4e95ff">{{ total }}</span>条信息
							</div>
							<!-- <span>卡片名称</span> -->
							<el-select
								size="medium"
						...
						<div v-for="item in searchResult" :key="item.id + item.wjlb">
							<div>
								<!-- 标题 -->
								<div class="result-title">
									<template>
										<router-link class="zc-hover"
											:to="{
...
// api
import { getList, getGbfl, getSpjscs,getSpjscs2,getSpdjzs,getSpmx } from '@/api/zbss'
//引入菜单数据
...
const searchDict = [
	...
	},
	{
		...
		childer: [
			...
			{ title: '招标文件', value: 5, active: false },
			{ title: '投标文件', value: 6, active: false },
		],
	},
]
...
<!-- 招采通用样式 -->
<style scoped src="../../styles/zbss.css"></style>
