  ...
  <div class="view-list row">
    <div class="col-md-3" id="dev-tree-left">
      ...
      <div class="tab-content" style="margin: 10px 0;" id="tab-tree-wrapper">
        <div class="tab-pane active" ref="devTreeWrapper" id="dev-tree-wrapper"  style="height:calc(100vh - 280px);overflow: hidden auto">
        ...
        <div class="tab-pane" ref="groupTreeWrapper" id="group-tree-wrapper" style="height:calc(100vh - 280px);overflow: hidden auto">
    ...
    <div id="dev-tree-right" class="row col-md-9" data-sticky-wrap data-sticky-for="1000" data-sticky-class="sticky">
      <div class="row hidden-xs">
        <div style="text-align:center" class="col-md-9 col-lg-10">
          <el-button-group class="player-btn-group">
...
import DeviceTreeNodeEditDlg from './DeviceTreeNodeEditDlg.vue';
import ChannelCustomListDlg from './ChannelCustomListDlg.vue';
